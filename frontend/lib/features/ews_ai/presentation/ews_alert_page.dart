...
class EwsAlertPage extends ConsumerWidget {
      ...
      body: SafeArea(
        child: Column(
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: List.generate(allInstructions.length, (
                          index,
                        ) {
            ...
            // Panel bawah yang stay (nggak ikut scroll): status kesiapan
            // peta + tombol "BUKA PETA EVAKUASI" selalu kelihatan tanpa
            // perlu scroll, karena ini aksi utama saat alert aktif.
            _buildMapActionBar(
              context,
  ...
  Widget _buildMapActionBar(
    ...
    if (isCacheReady) {
      label = 'Peta offline siap dipakai';
      icon = Icons.offline_pin_rounded;
      color = AppColors.success;
    } else if (hasInternet) {
      label = 'Peta online (live)';
      icon = Icons.wifi_rounded;
      color = AppColors.info;
    } else {
      label = 'Peta belum tersedia · ikuti instruksi AI di atas';
