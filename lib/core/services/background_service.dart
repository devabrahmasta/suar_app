...
void callbackDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    try {
      ...
      if (lastGempaTime != latestGempa.dateTime) {
        ...
        if (isTsunami || mag >= 7.0) {
          ...
          try {
            ...
            if (position != null) {
              ...
              // Jika lokasi gagal didapatkan, asumsikan peringatan untuk kehati-hatian
              isDanger = true;
            }
          } catch (e) {
            isDanger = true;
        ...
        if (isDanger) {
           ...
           await NotificationService.showNotification(
             ...
             body: 'Gempa M${latestGempa.magnitude} di ${latestGempa.wilayah}. ${latestGempa.potensi}',
             payload: 'EWS_ALERT',
           );
        }
      }
      ...
      return Future.value(true); // Return true so it doesn't infinitely retry on network errors unnecessarily
    }
  });
}
