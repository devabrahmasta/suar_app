...
class InaRiskService {
  ...
  Future<bool> checkLandslideHazard(double latitude, double longitude) async {
    try {
      const url =
          'https://gis.bnpb.go.id/server/rest/services/inarisk/layer_bahaya_tanah_longsor/MapServer/0/query';
